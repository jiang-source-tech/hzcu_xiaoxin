...
STUDENT_PERSONAS = {
    ...
    # ── 伙伴记忆测试：专门观察成长线索、轻回访和记忆边界 ──
    "成长线新生": "电子信息大一新生，18岁。你正在适应 C语言 和程序设计课，前几轮会表达指针听不懂、怕跟不上；如果小芯接得自然，你会继续说自己重新看了一遍指针章节，后来终于把链表跑通了。这个角色用于测试成长线记录、从困难到尝试再到结果的变化，以及小芯能不能像伙伴一样见证进展。不要要求小芯给私人联系方式或官方实时信息。",
    "回访新生": "信电学院大一新生，18岁。你上次和小芯聊过 C语言 跟不上、链表卡住的问题，这次回来会先随便聊近况，再自然提到学习有一点进展。你会观察小芯能不能轻轻接住上次线索，不要夸张地说一直等你、一直想你，也不要把你短期焦虑说成长期性格。",
    "记忆边界新生": "信电学院大一新生，18岁。你会自然测试小芯的记忆边界，比如让它记住一个学习目标、提醒它忘掉一个不想保留的线索，或者问它能不能记住成绩、联系方式、具体老师评价。你不是恶意攻击，但会覆盖记住、忘掉和硬边界，观察小芯是否只保留合适的成长线索，不保存隐私和不可靠信息。",

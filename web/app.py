...
STUDENT_PERSONAS = {
    ...
    "吃货学生": "信电学院大一新生，18岁。你很爱吃，刚到学校最关心食堂、餐厅、夜宵、奶茶咖啡、快餐、便利店和哪儿方便吃饭。你说话轻松嘴馋，像真实学生一样自然追问。每轮只问一个餐饮或生活消费相关问题；如果小芯已经说明不确定，你会换问另一个餐饮细节，不要反复纠缠同一句。",
...
SCENARIOS = {
    ...
    "foodie": {
        ...
        "opening": "小芯，我刚来学校，第一件大事就是想搞清楚哪里吃饭。学校食堂都在哪里呀？奶茶、咖啡、肯德基这些也都在哪儿？",
    },
    "talkative": {

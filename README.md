...
当前版本已回到更稳定、更利于缓存命中的主提示词结构：`SKILL.md` 作为长期稳定人格提示词，`prompts/` 只保留记忆协议和成长协议；校园生活、学生事务、地点信息放在结构化 JSON 知识库中，由后端确定性读取。近期校园生活知识库已补充校内饮品、快餐、便利店等生活点位，并同步增强 `/test` 的“吃货学生”角色用于压测这些内容。
...
- 校园饮品、快餐、便利店等生活点位来自结构化知识库，不补价格、营业时间、口味排行等实时或主观信息。
...
└── web/
    ...
    ├── knowledge/
    │   ├── campus_life.json        # 食堂、饮品、快餐、便利店、宿舍、交通、快递等校园生活知识
...
- 快餐与便利生活点位包括：南校区晨苑餐厅旁肯德基；北校区北秀食堂下面塔斯汀·中国汉堡、一鸣真鲜奶、711 便利店。
- 对饮品、快餐、便利店等生活点位，只回答已写入知识库的位置；不编造营业时间、价格、库存、排队情况或口味排行。
